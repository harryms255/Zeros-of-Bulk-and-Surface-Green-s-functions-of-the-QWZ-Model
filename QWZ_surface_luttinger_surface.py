...
zero_fit,zero_err=curve_fit(linear_fit,log_omega,log_SVD[0,:])
pole_fit,pole_err=curve_fit(linear_fit,log_omega,log_SVD[1,:])
...
colors=["r","b"]
label=["Zero, gradient={:.3f}".format(zero_fit[0]),"Pole, gradient={:.3f}".format(pole_fit[0])]
for i in range(2):
