# -*- coding: utf-8 -*-
"""
Created on Wed Feb  5 16:47:33 2025
...
for ax_indx,mu in enumerate(mu_values):
    ...
    for kx_indx,kx in enumerate(tqdm(kx_values)):
        for omega_indx,omega in enumerate(omega_values):
            LDOS_values[omega_indx,kx_indx]=-1/np.pi*np.trace(np.imag(analytic_BHZ_surface_Greens_function(omega, kx, t, mu, alpha,eta=0.0001j)))
